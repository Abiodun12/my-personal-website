...
export const blogPosts: BlogPost[] = [
  {
    ...
    date: '2025-08-10',
    description: 'I just finished my J.P. Morgan internship. I did a lot of applied AI engineering—built something that\'s actually going into production to help the company work more efficiently with unstructured data.',
    content: `# So It Starts Here…
...
All gas. No breaks. Let's get it.`
  },
  {
    ...
    date: '2025-02-25',
    description: 'Life has been moving fast lately. A few weeks ago, I was dealing with heartbreak—trying to process everything and move forward.',
